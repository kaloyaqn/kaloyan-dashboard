    ...
    () => [
      {
        ...
        accessor: ({ projectTitle, projectLink }) => (
          <>
            ...
            <a href={`https://${projectLink}`} className="project-link">
              {projectLink}
            </a>
          </>
        ),
        ...
        accessor: ({
          ...
          <>
            <div className="table-primary">
              {projectClientFirst} {projectClientLast}
            </div>
            <a
              href={`mailto:${projectClientEmail}`}
